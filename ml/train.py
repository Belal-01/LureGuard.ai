...
from ml.feature_contract import FEATURE_COLUMNS, FEATURE_DRIFT_COLUMNS, feature_contract_rows
...
def write_model_registry(out_dir: Path, model_path: Path, metrics: dict) -> Path:
...
def main() -> None:
    ...
    registry_path = write_model_registry(out_dir, model_path, result["metrics"])
